										...
										<tr>
											...
											<td><?php if ($shipment != NULL) {
													if ($shipment['status_pod'] == 0) { ?>
														<a data-toggle="modal" data-id="<?= $shipment['shipment_id'] ?>" data-shipper="<?= $shipment['shipper'] ?>" data-consigne="<?= $shipment['consigne'] ?>" data-destination="<?= $shipment['destination'] ?>" title="OTW Jakarta" class="open-modalOtw btn btn-icon waves-effect waves-light btn-danger btn-rounded" href="#modalOtw"><i class="fas fa-car"></i></a>
													<?php } elseif ($shipment['status_pod'] == 1) { ?>
														<a data-toggle="modal" data-id="<?= $shipment['shipment_id'] ?>" data-shipper="<?= $shipment['shipper'] ?>" data-consigne="<?= $shipment['consigne'] ?>" data-destination="<?= $shipment['destination'] ?>" title="Arrive Jakarta" class="open-Arrive btn btn-icon waves-effect waves-light btn-primary btn-rounded" href="#arrive"> <i class="fas fa-book"></i> </a>
													<?php } else { ?>
								...
								<div class="card-box">
									<div class="p-2">
										...
										<div class="form-group row">
											...
											<div class="col-md-10">
												<input type="text" disabled id="shipper" value="<?= $shipment['shipment_id'] ?>" name="example-input-small" class="form-control form-control-sm" placeholder=".input-sm">
											</div>
										</div>
