            ...
            <div class="card">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="text-center">
                        ...
                        <div class="form-group" id="datepickidcs">
                            ...
                            <?php foreach ($dataSalesTracker as $d) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($d['start_date'] != NULL && $d['end_date'] == NULL) { ?>
                                        ...
                                        <?php } ?><a href="<?= base_url('cs/MeetingTracker/detail/' . $d['id_sales_tracker']) ?>" class="btn btn-primary mt-2">Detail</a><a href="<?= base_url('cs/MeetingTracker/deleteSalesTracker/' . $d['id_sales_tracker']) ?>" onclick="return confirm_delete()" class="btn btn-danger ml-2 mt-2">Delete</a>
                                    </td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('cs/MeetingTracker/addNewMeeting') ?>" method="POST">
                    <div class="card-body">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin-top: -40px;">
                    <form action="<?= base_url('cs/MeetingTracker/checkOut') ?>" method="POST" enctype='multipart/form-data'>
                        <div class="card-body">
