            ...
            <div class="card">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="<?= base_url('cs/MeetingTracker/index/' . date('d/m/y', strtotime($dataSalesTracker['start_date']))) ?>" class="btn mr-2 text-light" style="background-color: #9c223b;">
                ...
                <div class="card-body" style="overflow: auto;">
                    <form action="<?= base_url('cs/MeetingTracker/editSalesTracker') ?>" method="POST" enctype="multipart/form-data">
                        <div class="card-body">
