										...
										<form action="<?= base_url('cs/ap/processAdd') ?>" method="POST" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="col-md-3">
													...
													<div class="form-group rec-element-ap">
														<input type="text" class="amount_proposed form-control" id="rupiah1" required name="amount_proposed[]">
													</div>
												</div>
												<div class="col-md-4">
													<label for="note_cs">Attachment 1</label>
													<div class="form-group rec-element-ap">
														<input type="file" class="form-control" id="attachment1" name="attachment[]" onchange="handleImageUpload(this.id);" accept="image/*" required capture>
