				...
				<div class="card card-custom card-stretch">
					<div class="card-header py-3">
						<div class="card-title align-items-start flex-column">
                            ...
                            <a onclick='$("#modalLoading").modal("show");' href="<?= base_url('cs/Milestone') ?>" class="btn mr-2 text-light" style="background-color: #9c223b;">
					...
					<div class="card-body" style="overflow: auto;">
						<div class="row">
							...
							<div class="col">
								<h4 class="title">Milestone AWB <?= $shipment['shipment_id'] ?></h4>
								<div class="row">
								...
								<br>
								<?php if ($shipment['shipment_id'] != NULL) {
								?>
									<a href="#" class="btn btn-sm text-light mb-1" data-toggle="modal" data-target="#modal-lg-dl-add<?= $shipment['shipment_id'] ?>" style="background-color: #9c223b;">
										...
										?>
											<tr>
												...
												<td>
													...
													<a href="<?= base_url('cs/Milestone/deleteShipmentTracking/' . $t['id_tracking'] . '/' . $t['shipment_id']) ?>" onclick="return confirm('Are you sure ?')" class="btn btn-sm text-light mb-1" style="background-color: #9c223b;">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?= base_url('cs/Milestone/updateShipmentTracking') ?>" method="POST" enctype="multipart/form-data">
						<div class="card-body">
							<div class="row">
...
<div class="modal fade" id="modal-lg-dl-update<?= $shipment['shipment_id'] ?>">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Add Update Status Shipment <b><?= $shipment['shipment_id'] ?></b> </h4>
			...
			<div class="modal-body">
				<form action="<?= base_url('cs/Milestone/updateShipmentTrackingAdd') ?>" method="POST" enctype="multipart/form-data">
					<div class="card-body">
						<div class="row">
							<input type="text" name="id_so" class="form-control" hidden value="<?= $t['id_so'] ?>">
...
<div class="modal fade" id="modal-lg-dl-add<?= $shipment['shipment_id'] ?>">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">ADD Update Status Shipment <b><?= $shipment['shipment_id'] ?></b> </h4>
