				...
				<div class="card">
					<div class="card-header">
						...
						<div class="card-toolbar">
							<a onclick='$("#modalLoading").modal("show");' href="<?= base_url('cs/ap') ?>" class="btn mr-2 text-light" style="background-color: #9c223b;">
								<i class="fas fa-chevron-circle-left text-light"> </i>
								Back
							</a>
							<a onclick="return confirm('Are you sure Void this ap ?');" href="<?= base_url('cs/Ap/voidAp/'.$info['no_pengeluaran']) ?>" class="btn mr-2 text-light" style="background-color: #9c223b;">
								<i class="fas fa-minus-circle text-light"></i>
								Void
							</a>

							<a onclick="return confirm('Are you sure return this ap ?');" href="<?= base_url('cs/Ap/takeBackAp/'.$info['no_pengeluaran']) ?>" class="btn mr-2 text-light" style="background-color: #9c223b;">
												...
												?>
													<tr>
														...
														<td><span <?php $approve = $this->db->get_where('tbl_approve_pengeluaran', array('no_pengeluaran' => $c['no_pengeluaran']));
															...
															<input type='number' name="jumlah" class='form-control txtedit' data-id="<?= $c['id_pengeluaran'] ?>" data-field='amount_proposed' data-url='<?= base_url() ?>/cs/ap/editApSatuanAjax' id='amount_proposedtxt_<?= $c['amount_proposed'] ?>' value='<?= $c['amount_proposed'] ?>'>
														</td>
