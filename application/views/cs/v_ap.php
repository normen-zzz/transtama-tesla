            ...
            <div class="card">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--begin::Button-->
                        <a onclick='$("#modalLoading").modal("show");' href="<?= base_url('cs/ap/add') ?>" class="btn font-weight-bolder text-light" style="background-color: #9c223b;">
                        ...
                        <a href="<?= base_url('cs/ap/history') ?>" class="btn btn-sm mb-1 text-light" style="background-color: #9c223b;"> <i class="fa fa-clipboard text-light"></i> History</a>
                    </div>
                </div>
