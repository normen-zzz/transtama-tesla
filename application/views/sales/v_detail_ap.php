						...
						<div class="card-body p-0">
							...
							<div class="row justify-content-center">
								<div class="col-xl-12 col-xxl-7">
									<!--begin: Wizard Form-->
									<form action="<?= base_url('sales/ap/processAddDetail') ?>" method="POST" enctype="multipart/form-data">
										<div class="row">
											<div class="col-md-4">
												...
												?>
													<tr>
														...
														<td>
															...
															<input type='text' class='form-control txtedit' data-id="<?= $c['id_pengeluaran'] ?>" data-field='description' data-url='<?= base_url() ?>/sales/ap/editApSatuanAjax' id='descriptiontxt_<?= $c['id_pengeluaran'] ?>' value='<?= $c['description'] ?>'>
														</td>
