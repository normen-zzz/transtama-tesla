					...
					<div class="card card-custom card-stretch">
						<div class="card-header py-3">
							<div class="card-title align-items-start flex-column">
								<h3 class="card-label font-weight-bolder text-dark">Add Special Request Pickup</h3>
							</div>
							...
							<div class="card-body p-0">
								...
								<div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
									<div class="col-xl-12 col-xxl-7">
										<!--begin: Wizard Form-->
										<form id="kt_form" novalidate="novalidate" action="<?= base_url('sales/salesOrder/processAddSpecial') ?>" method="POST" enctype="multipart/form-data">
											...
											<div class="pb-5" style="margin-top: -65px;">
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<select name="shipper_id" class="form-control" id="shipper_id">
																...
																?>
																	<option value="<?= $f['id_customer'] ?>" <?php if ($f['id_customer'] == set_value('shipper')) {
																													echo 'selected';
																												} ?>><?= $f['nama_pt'] ?></option>
																<?php  } ?>
															</select>
													...
													<input type="text" class="form-control" hidden name="shipper" value="<?php echo set_value('shipper'); ?>" id="shipper">
													<div class="col-md-4">
														<div class="form-group">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<div id="prefetch">
																<input type="number" class="form-control" min="1" max="100" required name="total_shipment" value="<?php echo set_value('total_shipment'); ?>">
															</div>
														</div>
													</div>
												</div>
