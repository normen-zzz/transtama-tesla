							...
							<div class="card-body p-0">
								...
								<div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
									<div class="col-xl-12 col-xxl-7">
										<!--begin: Wizard Form-->
										<form id="kt_form" novalidate="novalidate" action="<?= base_url('sales/RequestPrice/processAddSo/'.$detailrequest['id_detailrequest']) ?>" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<textarea name="destination" class="form-control" rows="10" cols="10"><?= $detailrequest['alamat_to'].', Kecamatan '.$detailrequest['kecamatan_to'].', Kabupaten '.$detailrequest['kota_to'].', Provinsi '.$detailrequest['provinsi_to']  ?></textarea>
														</div>
													</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<div id="prefetch">
																<input type="text" class="form-control" id="shipper" required name="shipper" value="<?= $customer['nama_pt'] ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
													...
													<div class="row">
														...
														<div class="col-md-4">
															<div class="form-group">
																...
																<input type="text" class="form-control" required name="pu_poin" value="<?= $detailrequest['kota_from'] ?>">
															</div>
														</div>
														<div class="col-md-4">
															<div class="form-group">
														...
														<div class="col-md-4">
															<div class="form-group">
																...
																<input type="text" class="form-control" required name="commodity" value="<?= $detailrequest['jenis'] ?>">
															</div>
														</div>
														<div class="col-md-2">
															<div class="form-group">
																<label for="exampleInputEmail1">Koli</label>
																<input type="number" class="form-control" name="koli" value="<?= $detailrequest['koli'] ?>">
															</div>
														</div>
