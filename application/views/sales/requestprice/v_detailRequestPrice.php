                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                                <div class="col col-sm-12">
                                    ...
                                    <?php if ($detailRequestPrice['status'] == 0) { ?>
                                               

                                    <form id="kt_form" novalidate="novalidate" action="<?= base_url('sales/requestPrice/processEditRequestPrice/'.$detailRequestPrice['id_detailrequest']) ?>" method="POST" enctype="multipart/form-data">
<?php } ?>
                                        <div style="margin-top: -65px;">
                                            ...
                                            <div id="formRequest">
                                                ...
                                                <h4 class="mb-10 font-weight-bold text-dark mt-4"><b>
                                                        <div id="nomorKolom">INFORMATION </div>
                                                    </b>
                                                    ...
                                                    <div class="row border mt-4">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="alamat_from" id="alamat" cols="30" rows="2"><?php echo $detailRequestPrice['alamat_from'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row border mt-4">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Kecamatan<span style="color: red;">*</span></label>
                                                                <input type="text" class="form-control" id="kecamatan_to" required name="kecamatan_to" value="<?php echo $detailRequestPrice['kecamatan_to'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="alamat_to" id="alamat_to" cols="30" rows="2"><?php echo $detailRequestPrice['alamat_to'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" required name="jenis" value="<?php echo $detailRequestPrice['jenis'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">Berat (KG)</label>
                                                                <input type="number" class="form-control" required name="berat" value="<?php echo $detailRequestPrice['berat'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" required name="koli" value="<?php echo $detailRequestPrice['koli'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" required name="panjang" value="<?php echo $detailRequestPrice['panjang'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" required name="lebar" value="<?php echo $detailRequestPrice['lebar'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" required name="tinggi" value="<?php echo $detailRequestPrice['tinggi'] ?>">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="notes" id="notes" cols="30" rows="2"><?php echo $detailRequestPrice['notes_sales'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                            ...
                                            <?php if ($detailRequestPrice['status'] == 0) { ?>
                                                <div>
                                                    <button onclick='$("#modalLoading").modal("show");' type="submit" class="btn btn font-weight-bolder text-uppercase px-9 py-4 text-light" data-wizard-type="action-submit" style="background-color: #9c223b;">Edit</button>
                                                </div>
                                            <?php } ?>
