												...
												?>
													<tr>
														...
														<td>
															...
															<input type='text' class='form-control txtedit' data-id="<?= $c['id_pengeluaran'] ?>" data-url='<?= base_url() ?>/finance/ap/editApSatuanAjax' data-field='description' id='descriptiontxt_<?= $c['id_pengeluaran'] ?>' value='<?= $c['description'] ?>'>
														</td>
