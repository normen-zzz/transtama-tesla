            ...
            <div class="card">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--begin::Button-->
                        <a onclick='$("#modalLoading").modal("show");' href="<?= base_url('finance/ap/add') ?>" class="btn font-weight-bolder text-light" style="background-color: #9c223b;">
                            <span class="svg-icon svg-icon-md">
                                <i class="fa fa-plus text-light"></i>
                                <!--end::Svg Icon-->
                            </span>Add</a>
                        <!--end::Button-->
                        <a href="<?= base_url('finance/ap/history') ?>" class="btn btn-sm mb-1 text-light" style="background-color: #9c223b;"> <i class="fa fa-clipboard text-light"></i> History</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($id_atasan == NULL || $id_atasan == 0) {
                                            if ($c['status'] <= 0) {
                                        ?>
                                                <a href="<?= base_url('finance/ap/approve/' . $c['no_pengeluaran']) ?>" onclick="return confirm('Are You Sure ?')" class="btn btn-sm mb-1 text-light" style="background-color: #9c223b;">Approve</a>
                                                <a onclick='$("#modalLoading").modal("show");' href="<?= base_url('finance/ap/detail/' . $c['no_pengeluaran']) ?>" class="btn btn-sm mb-1 text-light" style="background-color: #9c223b;">Detail</a>
