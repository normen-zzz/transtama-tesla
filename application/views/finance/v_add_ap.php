							...
							<div class="card-body p-0">
								...
								<div class="row justify-content-center">
									<div class="col-xl-12 col-xxl-7">
										<!--begin: Wizard Form-->
										<form action="<?= base_url('finance/ap/processAdd') ?>" method="POST" enctype="multipart/form-data">
											<div class="row">
												<div class="col-md-4">
												...
												<div class="col-md-4" style="display: none;" id="car">
													...
													<div class="form-check">
														<input class="form-control" id="no_ca" type="text" name="no_ca">
													</div>
												</div>
											...
											<div class="row">
												<div class="col-md-2">
													...
													<div class="form-group rec-element-ap">
														<input type="text" class="form-control id_category" required id="id_category1" name="id_category[]">
												...
												<div class="col-md-3">
													...
													<div class="form-group rec-element-ap">
														<input type="text" class="amount_proposed form-control" id="amount1" required name="amount_proposed[]">
													</div>
												</div>
												<div class="col-md-4">
													<label for="note_cs">Attachment 1</label>
													<div class="form-group rec-element-ap">
														<input type="file" class="form-control" id="attachment1" name="attachment[]" onchange="handleImageUploadTracker(this.id);" accept="image/*" required capture="camera">
														<input type="file" class="form-control" id="upload_file-attachment1" name="attachment2[]" accept="image/*" capture hidden>
													</div>
												</div>
