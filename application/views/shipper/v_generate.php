                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- <a href="<?= base_url('superadmin/order/exportGenerateGenerateResi/' . $gn['id_customer'] . '/' . $gn['group']) ?>" class="btn btn-sm text-light mb-1" style="background-color: #9c223b;">
                                            Export Excell</a> -->
                                        <a href="<?= base_url('shipper/order/generatePdfGenerateResi/' . $gn['group']) ?>" class="btn btn-sm text-light mb-1" style="background-color: #9c223b;">
                                            Print PDF</a>
                                    </td>
                                </tr>
                            <?php } ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('superadmin/order/generateResi') ?>" method="POST">
                    <div class="card-body">
                        <div class="row">
