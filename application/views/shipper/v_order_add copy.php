													...
													<div class="row">
														...
														<div class="col-md-2">
															<div class="form-group">
																...
																<input type="text" class="form-control" name="note_cs[]" value="<?php echo set_value('note_cs'); ?>">
															</div>
														</div>
														<div class="col-md-2">
															<div class="form-group">
														...
														<!-- <div class="col-md-2">
															<div class="form-group">
																...
																<input type="text" class="form-control" name="no_so" value="<?php echo set_value('no_so'); ?>">
															</div>
														</div> -->
														<div class="col-md-2">
															<div class="form-group">
													...
													<div class="row">
														<div class="col-md-4">
															<div class="form-group">
																...
																<input type="file" class="form-control" name="ktp[]" onchange="preview_image();" accept="image/*" capture multiple id="upload_file">
															</div>
														</div>
