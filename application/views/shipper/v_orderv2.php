					...
					<div class="card card-custom card-stretch">
						<div class="card-header py-3">
							...
							<div class="card-toolbar">
								<a onclick='$("#modalLoading").modal("show");' href="<?= base_url('shipper/order/add/' . $id_so) ?>" class="btn mr-2 text-light" style="background-color: #9c223b;">
						...
						<div class="card-body" style="overflow: auto;">
							<table id="myTable" class="table table-bordered">
								<div class="col-md-2 mt-4">
									...
									<a href="<?= base_url('shipper/order/completeTtd/' . $id_so) ?>" class="btn mr-2 text-light mt-1" style="background-color: #9c223b;">
										<i class="fas fa-print text-light"> </i>
										Complete TTD & POP
									</a>
									...
									?>
										<tr>
											...
											<td>
												...
												<a onclick='$("#modalLoading").modal("show");' href="<?= base_url('shipper/order/edit/' . $o['id'] . '/' . $o['id_so']) ?>" class="btn btn-sm text-light ml-2" style="background-color: #9c223b;">Edit</a>
											</td>
