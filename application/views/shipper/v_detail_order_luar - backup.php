												...
												?>
													<td>
														...
														?>
															...
															?>
																...
																<button  class="btn btn-sm text-light modalDelivery" data-toggle="modal" data-target="#modal-lg-dl" data-shipment_id="<?= $shp['shipment_id'] ?>" style="background-color: #9c223b;">
																	Assign Driver DL
																</button>
													...
													?>
														<td>
															...
															<?php if ($tracking_real == NULL) {
															?>
																<button href="#" class="btn btn-sm text-light mb-4 modalDriverIncomingLangsung" data-toggle="modal" data-target="#modal-driver-incoming-langsung" data-shipment_id="<?= $shp['shipment_id'] ?>" style="background-color: #9c223b;">
																	Asign Driver DL
																</button>
															...
															<?php	} else {
															?>
																<button href="#" class="btn btn-sm text-light mb-4 modalDriverIncomingLangsung" data-toggle="modal" data-target="#modal-driver-incoming-langsung" style="background-color: #9c223b;">
																	Asign Driver DL
																</button>
																<div class="symbol symbol-40 symbol-light-success">
																	<span class="symbol-label">
													...
													?>
														<td>
															...
															?>
																<button href="#" class="btn btn-sm text-light mb-4 modalDriverIncoming" data-toggle="modal" data-target="#modal-driver-incoming" data-shipment_id="<?= $shp['shipment_id'] ?>" style="background-color: #9c223b;">
																	Asign Driver DL
																</button>
				...
				$.ajax({
					...
					success: function(response) {
						...
						var content = '<div class="card-body">' +
							...
							'<div class="col-md-6">' +
							'<b>Image  :</b> <img src="<?= base_url("uploads/berkas/") ?>' + response.bukti + '" height="100" width="200"> <br>' +
