										...
										<div class="card-body">
											...
											<form class="position-relative" style="height: 20px;">
												<div class="position-absolute top-0 right-0 mt-n1 mr-n2">
													<a href="<?= base_url('shipper/salesOrder/receive/' . $shipment['id_so'] . '/' . $shipment['id_tracking'] . '/' . $shipment['shipment_id']) ?>" onclick="return confirm('You will accept this Request')" class="btn text-light" style="background-color: #9c223b;">Receive Task</a>
												</div>
											</form>
											<!--edit::Editor-->
										</div>
					...
					15px;">No Activity Right Now </span>
									...
									?>
										<div class="card-body">
											...
											<form class="position-relative" style="height: 20px;">
												<div class="position-absolute top-0 right-0 mt-n1 mr-n2">
													<a href="<?= base_url('shipper/salesOrder/receiveDelivery/' . $shipment['id_so'] . '/' . $shipment['shipment_id'] . '/' . $shipment['id_tracking']) ?>" onclick="return confirm('You will accept this Request')" class="btn text-light" style="background-color: #9c223b;">Receive Task</a>
												</div>
											</form>
											<!--edit::Editor-->
										</div>
									...
									?>
										...
										?>
											<div class="card-body">
												...
												<form class="position-relative" style="height: 20px;">
													<div class="position-absolute top-0 right-0 mt-n1 mr-n2">
														<a href="<?= base_url('shipper/salesOrder/receiveDeliveryHub/' . $shipment['id_tracking']) ?>" onclick="return confirm('You will accept this Request')" class="btn text-light" style="background-color: #9c223b;">Receive Task</a>
													</div>
												</form>
												<!--edit::Editor-->
											</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="file" id="photo_pod1<?= $shipment['shipment_id'] ?>" class="form-control" name="imagebefore" onchange="handleImageUploadTracker(this.id);" accept="image/*" capture required>
											<input type="file" class="form-control" id="upload_file-photo_pod1<?= $shipment['shipment_id'] ?>" name="ktp[]" accept="image/*" capture hidden>
										</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInputEmail1">POD</label>
											<!-- <input type="file" class="form-control" name="ktp"> -->
											<input type="file" id="photo_pod2<?= $shipment['shipment_id'] ?>" class="form-control" name="imagebefore" onchange="handleImageUploadTracker(this.id);" accept="image/*" capture required>
											<input type="file" class="form-control" id="upload_file-photo_pod2<?= $shipment['shipment_id'] ?>" name="ktp[]" accept="image/*" capture hidden>
							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label for="exampleInputEmail1">POD</label>
											<input type="file" id="photo_pod3<?= $shipment['shipment_id'] ?>" class="form-control" name="imagebefore" onchange="handleImageUploadTracker(this.id);" accept="image/*" capture required>
											<input type="file" class="form-control" id="upload_file-photo_pod3<?= $shipment['shipment_id'] ?>" name="ktp[]" accept="image/*" capture hidden>
