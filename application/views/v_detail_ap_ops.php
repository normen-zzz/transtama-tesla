					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								?>
									<a onclick="return confirm('Are You Sure ?')" href="<?= base_url('approval/approveMgrOps/' . $info['no_pengeluaran']) ?>" class="btn mr-2 text-light" style="background-color: #9c223b;">
