...
<section class="content">
    <div class="container-fluid">
        <!-- Info boxes -->
        <div class="col-md-12">
            <form action="<?= base_url('baak/pengajuan/laporan') ?>" method="POST">
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>Filter By Fakultas</label>
                    ...
                    <div class="col-md-2 mt-8">
                        ...
                        <a href="<?= base_url('baak/pengajuan/laporan') ?>" class="btn btn-primary">Reset Filter</a>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <table id="myTable" class="table table-bordered">
                            ...
                            <?php if (isset($id_fakultas) && isset($id_prodi) && isset($status)) { ?>
                                <a href="<?= base_url('baak/pengajuan/cetakLaporan/' . encrypt_url($id_fakultas) . '/' . encrypt_url($id_prodi) . '/' . encrypt_url($status)) ?>" class="btn btn-danger mr-2 mb-4">
                                    <i class="fas fa-print"> </i>Cetak
                                </a>
                            <?php } else { ?>
                                <a href="<?= base_url('baak/pengajuan/cetakLaporan/') ?>" class="btn btn-danger mr-2 mb-4">
                                    <i class="fas fa-print"> </i>Cetak
                                </a>
                            <?php } ?>
