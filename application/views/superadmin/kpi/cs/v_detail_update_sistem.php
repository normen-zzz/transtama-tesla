            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h2 class="card-title">KPI DETAIL UPDATE SISTEM CS
                            <div class="row">
                                <form action="<?= base_url('superadmin/Kpi/detailUpdateSistem') ?>" method="POST">
                                <div class="row ml-2">
                        ...
                        <table class="table table-bordered datatable">
                            ...
                            <tbody>
                                ...
                                foreach ($resi->result_array() as $s) {
                                    ...
                                    $date2 = date_create(date('Y-m-d', strtotime($s['updatesistem_at'])));
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php if ($s['updatesistem_at'] != NULL) {
                                                echo date('d F Y', strtotime($s['updatesistem_at']));
                                            } ?></td>

                                        <td><?php if ($s['update_at'] != NULL) {
                                                echo getGrade($nilai);
                                            } ?>
                                        </td>
