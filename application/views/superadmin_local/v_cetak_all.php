    ...
    <?php foreach ($orders as $order) { ?>
            ...
            <table border="0">
                <tr>
                    ...
                    <td style="font-size: 20px; padding-top:25px; font-weight:bold;">
                        <b style="margin-left: 30px;"><?= $order['prefix'] ?></b>
                    </td>
                </tr>
            </table>
        ...
        <div class="content" style="border: 1px solid black;margin-left: -15px; margin-right:5px">
            ...
            <table style="width:100%; border-top:1px solid black;">
                <tr>
                    <td style=" font-size: 8px; text-align:left"><b>Consignee :</b> <?= ucwords(strtolower($order['consigne'])) . '<br>' . ucwords($order['destination']) . '. ' . '<br>'  . '<b>' . ucwords(strtolower($order['city_consigne'])) . '</b>' . ', ' . '<b>' . ucwords(strtolower($order['state_consigne'])) . '</b>'  ?>
                        <b>Indonesia</b>
                    </td>
                </tr>
            ...
            <table>
                <tr>
                    <td style="border-bottom: 1px solid black;border-top: 1px solid black;font-size: 8px;">
                        DO Number :
                        <?php
