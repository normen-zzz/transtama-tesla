                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                <a class="dropdown-item" data-toggle="modal" data-target="#modalEdit<?= $p['id_city'] ?>">Edit</a>
...
<?php foreach ($city as $p) { ?>
    <div class="modal fade" id="modalEdit<?= $p['id_city'] ?>">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit <?= $p['city_name'] ?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('superadmin/city/edit') ?>" method="POST">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Name of City</label>
                                        <input type="text" class="form-control" value="<?= $p['city_name'] ?>" name="city_name">
                                        <input type="text" hidden class="form-control" value="<?= $p['id_city'] ?>" name="id_city">
                                    </div>
