...
<body style="font-family:'Open Sans',sans-serif; margin:-15px; margin-top:-50px;" onload="window.print()">
    ...
    <div class="content" style="border: 1px solid black;margin-left: -15px; margin-right:5px">
        ...
        <table style="width:100%; border-top:1px solid black;">
            <tr>
                <td style=" font-size: 9px; text-align:left"><b>Consignee :</b> <?= ucwords(strtolower($order['consigne'])) . '<br>' . ucwords($order['destination']) . '. ' . '<b>' . ucwords(strtolower($order['city_consigne'])) . '</b>' . ', ' . '<b>' . ucwords(strtolower($order['state_consigne'])) . '</b>'  ?>
                    <b>Indonesia</b>
                </td>
            </tr>
