                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="overflow: auto;">
                            <div class="card-body p-0">
                                <!--begin: Wizard-->
                                <form action="<?= base_url('Wilayah/kabupaten') ?>" method="POST">

                                    <div class="form-group">
                                        <label for="provinsi">provinsi</label>
                                        <select class="form-control" name="provinsi" id="provinsi">
                                            <?php foreach ($provinsi as $provinsi) { ?>
                                                <option <?php if ($provinsiselected == $provinsi->id) {
                                                            echo 'selected';
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="<?= base_url('Wilayah/kecamatan/' . $provinsiselected . '/' . $kabupaten->id) ?>" class="btn btn-primary" target="_blank">Get Data Kecamatan</a></td>
                                                        </tr>
