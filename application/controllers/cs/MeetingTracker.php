...
class MeetingTracker extends CI_Controller
{
    ...
    public function detail($id)
    {
        ...
        $this->backend->display('cs/v_detail_sales_tracker', $data);
    }
    ...
    public function addNewMeeting()
    {
        ...
        if ($this->db->insert('tbl_sales_tracker', $dataNewMeeting)) {
            ...
            redirect('cs/MeetingTracker/index/' . date('d/m/y', strtotime($this->input->post('start_date'))));
        } else {
            $this->session->set_flashdata('message', '<div class="alert
