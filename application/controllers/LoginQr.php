...
class LoginQr extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('frontend/login-qr');
        } else {
            $this->_login();
        }
    }
    ...
    {
        $result_code = $this->input->post('id_user');
    ...
    {
        $result_code = $this->input->post('id_user');
        $user = $this->db->get_where('tb_user', ['username' => $result_code])->row_array();
        ...
        if ($user) {
            ...
            $this->session->set_flashdata('message', '<div class="alert
                alert-danger" role="alert">Tidak terdaptar</div>');
            redirect('loginQr');
        }
    }
