...
class Order extends CI_Controller
{
    ...
    {
        //$data = $this->Api->http_request("https://jsonplaceholder.typicode.com/posts");
        //var_dump($data); die;
    ...
    public function processAdd()
    {
        ...
        // $this->form_validation->set_rules('note_cs', 'Note_cs', 'trim');
        // $this->form_validation->set_rules('no_so', 'no_so', 'trim');
        $this->form_validation->set_rules('no_stp', 'no_stp', 'trim');
        $this->form_validation->set_rules('note_driver', 'Note_driver', 'trim');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                'order' => array(
                    ...
                    'destination_attributes' => array(
                        ...
                        'address_line2' => $this->input->post('state_consigne'),
            ...
            if ($new) {
                ...
                // $deadline_pic_js = date('Y-m-d', strtotime('+2 days', strtotime($deadline_sales)));
                // $deadline_manager_cs = date('Y-m-d', strtotime('+1 days', strtotime($deadline_pic_js)));
                ...
                $data = array(
                    ...
                    // 'deadline_manager_cs' => $deadline_manager_cs,
                );
